...
if __name__ == "__main__":
    ...
    client.tasks.add_task(func=func(channel_id=123, message_content="test", times=100), name="spam_1")
    client.tasks.add_task(func=func(channel_id=123, message_content="test", times=100), name="spam_2")
    client.tasks.add_task(func=func(channel_id=123, message_content="test", times=100), name="spam_2")
