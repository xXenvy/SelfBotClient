...
class Client(HTTPClient):
    ...
    async def on_channel_edit(self, user: UserClient, edited_channel: dict) -> None:
        ...

    async def on_guild_update(self, user: UserClient, guild_data: dict) -> None:
        ...
    ...
    async def on_member_join(self, user: UserClient, member_data: dict) -> None:
        ...

    async def on_member_leave(self, user: UserClient, member_data: dict) -> None:
        ...
